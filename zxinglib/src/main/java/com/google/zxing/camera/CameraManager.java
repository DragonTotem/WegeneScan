...
import com.google.zxing.parse.PlanarYUVLuminanceSource;
...
public final class CameraManager {
    ...
    public void openDriver(SurfaceHolder holder) throws IOException {
        ...
        try {
            ...
            // Driver failed
            LogUtil.w("Camera rejected parameters. Setting only minimal safe-mode parameters");
            ...
            if (parametersFlattened != null) {
                ...
                try {
                    ...
                    // Well, darn. Give up
                    LogUtil.w("Camera rejected even safe-mode parameters! No configuration");
                }
            }
        }
    ...
    /**
     * Convenience method for {@link BaseCaptureActivity}
     *
    ...
    public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data, int width, int height) {
        ...
        int top = (height - size) / 3 + framingRectVerticalOffset;
